...
module.exports = {
    ...
    module: {
        rules: [
            {
                test: /\.js?$/, // expresion regular para indentificar los archivos js
                exclude: /node_modules/, // excluir la carpeta node_modules
                use: {
                    loader: 'babel-loader', // utiliar el loader de babel
                    }
                }
            ]
        },
    ...
    new CopyWebpackPluguin({
        patterns: [{ from: './src/styles/styles.css', // archivo de css de entrada
        to: 'styles.css' }],
        })
    ]
}  
